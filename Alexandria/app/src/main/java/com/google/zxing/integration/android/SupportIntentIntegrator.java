...
/* Renamed and updated to support support fragments */
 ...
 *
 * <p>To integrate, create an instance of {@code SupportIntentIntegrator} and call {@link #initiateScan()} and wait
 ...
 *   IntentResult scanResult = SupportIntentIntegrator.parseActivityResult(requestCode, resultCode, intent);
 *   if (scanResult != null) {
 *     // handle scan result
 *   }
 ...
 *
 * <pre>{@code
 * SupportIntentIntegrator integrator = new SupportIntentIntegrator(yourActivity);
 ...
 * @author gcstang
 */
public class SupportIntentIntegrator {
     ...
     */
    public SupportIntentIntegrator(Activity activity) {
     ...
     *  of an {@link Activity}
     */
    public SupportIntentIntegrator(Fragment fragment) {
